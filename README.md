...
| OpenWrt 22.03 + вендорское ядро 4.9 | 4.9.206 | 22.03 | ✅ | ✅ | ядро собирается, упаковка kmod — нет ([разбор](docs/09-openwrt-2203.md)) |
| OpenWrt 22.03 + порт BSP на 5.10 | 5.10 | свежий | ⚠️ порт драйвера | ⚠️ порт datapath | 1183 новых + 437 изменённых файлов ядра |
...
- [x] Проверена база **OpenWrt 22.03**: вендорское ядро 4.9.206 собирается тулчейном
      22.03 (GCC 11.2), но упаковка модулей ядра не стыкуется — определения kmod в
      OpenWrt привязаны к ядру своего релиза ([`docs/09-openwrt-2203.md`](docs/09-openwrt-2203.md))
